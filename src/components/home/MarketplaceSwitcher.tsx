...
export default function MarketplaceSwitcher() {
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      case 'blue': return 'bg-blue-100 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400';
      ...
      default: return 'bg-gray-100 dark:bg-gray-950/30 text-gray-600 dark:text-gray-400';
    }
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {verticals.map((v) => {
          ...
          return (
            ...
            >
              <div className={`w-14 h-14 ${getColorClasses(v.color)} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                <Icon size={28} />
              </div>
